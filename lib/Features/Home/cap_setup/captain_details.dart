import 'package:e_gem_test3/nav_screens/home/Captain/reviews.dart';
import 'package:e_gem_test3/nav_screens/home/Captain/transformation.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
          child: Column(
            children: [
              Image.asset("assets/images/mohamed_ali.png",width: double.infinity,fit: BoxFit.fitHeight,),
              Padding(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          VerticalDivider(color: Color(0xFFBB2525),thickness: 1.5,),
                          Column(
                            children: [
                              Text('46',
                                textAlign: TextAlign.center,
