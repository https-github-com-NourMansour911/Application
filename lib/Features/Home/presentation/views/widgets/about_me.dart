...
class AboutMeCoach extends StatelessWidget {
  const AboutMeCoach({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Certificate(certificate: Assets.imagesCertificate2),
              Certificate(certificate: Assets.imagesCertificate1),
            ],
          ),
        ],
      ),
