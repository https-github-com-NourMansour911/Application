          ...
          children: [
            ...
            GestureDetector(
                onTap: () => Navigator.push(context,MaterialPageRoute(builder: (context)=>
                    ExerciseDetailsViewBody(idx+1))),
                child: ExerciseCard(exercise: exercise[idx+1], reps: reps[idx+1], exeImage: Strings().exeImg[idx+1])),
            SizedBox(height: 8.h,),
            GestureDetector(
                onTap: () => Navigator.push(context,MaterialPageRoute(builder: (context)=>
                    ExerciseDetailsViewBody(idx+2))),
                child: ExerciseCard(exercise: exercise[idx+2], reps: reps[idx+2], exeImage: Strings().exeImg[idx+2])),
            SizedBox(height: 8.h,),
            GestureDetector(
                onTap: () => Navigator.push(context,MaterialPageRoute(builder: (context)=>
                    ExerciseDetailsViewBody(idx+3))),
                child: ExerciseCard(exercise: exercise[idx+3], reps: reps[idx+3], exeImage: Strings().exeImg[idx+3])),
          ],
        );
      }else if(idx < 8){
        return Column(
